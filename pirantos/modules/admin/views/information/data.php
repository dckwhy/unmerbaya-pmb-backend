...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/Information/detail/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/Information/edit/'+id) 
}
</script>
<script>
...
function act_delete(id){
    where_value = id;
    where_field = 'id';
    table_name  = 'data_informasi';
    $('.loading').show();
    $.ajax({
        type :"post",  
        url : "<?php echo base_url('admin/Information/delete_data') ?>",  
        cache :false,
