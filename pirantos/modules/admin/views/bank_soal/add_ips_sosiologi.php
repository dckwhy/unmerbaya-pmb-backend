                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                 <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Add Soal Sosiologi</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<script>
    $(function() {
        ...
        $('#input_data').on('submit', function (e) {
            ...
            $.ajax({
                type :"post",  
                url : "<?php echo base_url('admin/About_us/update_content') ?>",  
                cache :false,
                ...
                success : function(data) {
                    if (data.msg == 'success') {
                        ...
                        setTimeout(function(){
                            window.location = "<?php echo base_url('admin/about_us') ?>";
                        },2000)
