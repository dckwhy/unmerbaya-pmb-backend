                        ...
                        <div class="row"> 
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    $this->db->where('id', $id);
                                    $row = $this->db->get('unmer_bank_soal.ipa')->row();
                                    ?>
                                    <form  id="input_data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" required name="code" value="<?php echo @$row->code ?>" placeholder="Kode Soal" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Soal</label>
                                                        <textarea type="text" class="form-control" required name="Soal" placeholder="Soal" disabled><?= $row->soal ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Score</label>
                                                        <input type="text" class="form-control" required name="score" value="<?php echo @$row->score ?>" placeholder="Score" disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" required name="jwb_1" value="<?php echo @$row->jwb_1 ?>" placeholder="Pilihan 1" disabled>
                                                        <br>
                                                        <input type="text" class="form-control" required name="jwb_2" value="<?php echo @$row->jwb_2 ?>" placeholder="Pilihan 2" disabled>
                                                        <br>
                                                        <input type="text" class="form-control" required name="jwb_3" value="<?php echo @$row->jwb_3 ?>" placeholder="Pilihan 3" disabled>
                                                        <br>
                                                        <input type="text" class="form-control" required name="jwb_4" value="<?php echo @$row->jwb_4 ?>" placeholder="Pilihan 4" disabled>
                                                        <br>
                                                        <input type="text" class="form-control" required name="jwb_5" value="<?php echo @$row->jwb_5 ?>" placeholder="Pilihan 5" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <label for="">Pembahasan</label>
                                                    <div class="summernote" disabled><?php echo @$row->pembahasan ?></div>
