                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                 <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Add Soal Sejarah</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Add Soal Sejarah</h5> 
                                        <a href="<?php echo base_url('admin/Bank_soal/add_ips_sejarah') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                        <a href="<?php echo base_url('admin/Bank_soal/ipa_sejarah') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
                                    <form  id="input_data">
