                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                   <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Sejarah</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/Bank_soal/detail_ips_sejarah/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/Bank_soal/edit_ips_sejarah/'+id) 
}
</script>
<script>
