                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                   <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Ekonomi</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Data Soal Ekonomi</h5>
                                        <a href="<?php echo base_url('admin/Bank_soal/add_ips_ekonomi') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                        <a href="<?php echo base_url('admin/Bank_soal/ips_ekonomi') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/Bank_soal/detail_ips_ekonomi/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/Bank_soal/edit_ips_ekonomi/'+id) 
}
</script>
<script>
