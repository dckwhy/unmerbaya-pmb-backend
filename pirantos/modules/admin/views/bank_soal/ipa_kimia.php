                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                   <li class="breadcrumb-item"><a href="#">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Kimia</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Data Soal Kimia</h5> 
                                        <a href="<?php echo base_url('admin/Bank_soal/add_ipa_kimia') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                        <a href="<?php echo base_url('admin/Bank_soal/ipa_kimia') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/Bank_soal/detail_ipa_kimia/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/Bank_soal/edit_ipa_kimia/'+id) 
}
</script>
<script>
