                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <a href="<?php echo base_url('admin/persyaratan/add') ?>" class="btn shadow-2 btn-success pull-right">Add</a> 
                                        <a href="<?php echo base_url('admin/persyaratan/data') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                                    </div>
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="zero-configuration" class="display table nowrap table-striped table-hover" style="width:100%">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $get_data_syarat = $this->db->get('unmer_core.data_persyaratan')->result();
                                                    foreach ($get_data_syarat as $value) { ?>
                                                    <tr>
                                                        <td><?= $value->id ?></td>
                                                        <td><?= text_limit($value->content, 8) ?></td>
                                                        <td>
...
function get_detail (id) {  
    window.location = ('<?= base_url() ?>admin/persyaratan/detail/'+id)
}
function get_edit (id) {
    window.location = ('<?= base_url() ?>admin/persyaratan/edit/'+id) 
}
</script>
<script>
